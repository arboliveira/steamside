...
export class WorldSettingsKidsKidEditElement extends CustomaryElement {
	/**
	 * @type {CustomaryDeclaration<WorldSettingsKidsKidEditElement>}
	 */
	static customary =
		{
				...
				events: [
					{
						...
						listener: (el, e) => el['kid_name'] = e.target.value,
					},
					{
					...
					{
						selector: "#SaveButton",
						listener: (el, e) => el.#on_Save_click(e),
					},
					{
						selector: "#DeleteKid",
	...
	#on_TagStickerElement_TagClicked(e) {
		this.#switchInventory();
	}
