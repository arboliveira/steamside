...
export class WorldSettingsCloudElement extends CustomaryElement {
	/**
	 * @type {CustomaryDeclaration<WorldSettingsCloudElement>}
	 */
	static customary =
		{
			...
			hooks: {
				...
				events: [
					...
					},
					{
						...
						listener: (el, e) => el.cloudSyncedLocation = e.target.value,
					},
				],
			}
		}
	...
	#on_cloudSettings_change(a) {
		this.__cloudEnabled = this.__cloudSettings.cloudEnabled;
