...
export class GameCardElement extends CustomaryElement
{
			...
			hooks: {
				...
				events: [
					...
					},
					{
						...
						listener: (el, e) =>
							Skyward.stage<CardTag.PleaseDetail>(e, el,
								{
	...
	declare card_scale: string;
	declare card_scale_style: string;
	declare image_resolved: string;
	...
	#on_changed_card(cardView: CardView) {
