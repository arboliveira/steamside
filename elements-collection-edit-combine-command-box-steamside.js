...
export class CollectionEditCombineCommandBoxElement extends CustomaryElement {
    ...
    #updateHints(input_value) {
        ...
        if (input_value === this.collection_editing_name
    ...
    #updateHints_collapsing(collection_targeting) {
        ...
        const l_name = same_as_editing ? this.collection_editing_name : this.collection_combining_name;
        const r_name = same_as_editing ? this.collection_combining_name : this.collection_editing_name;
        this.verbA = 'Update';
        this.subjectA =
...
//# sourceMappingURL=elements-collection-edit-combine-command-box-steamside.js.map