...
export class CustomaryTestingQueries {
    static matchesTextContent(element, expected) {
        return CustomaryTesting.allTextContent(element) === expected;
    }
    static findByTextContent(container, expected, { selector }) {
    ...
    static findByClass(container, expected, { selector }) {
        const elements = querySelectorAll(container, selector);
        for (const element of elements) {
...
//# sourceMappingURL=CustomaryTestingQueries.js.map