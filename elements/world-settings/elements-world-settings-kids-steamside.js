...
import { WorldSettingsKidsKidEditElement } from "#steamside/elements/world-settings/elements-world-settings-kids-kid-edit-steamside.js";
...
export class WorldSettingsKidsElement extends CustomaryElement {
        ...
        hooks: {
            ...
            events: [
                ...
                },
                {
                    ...
                    listener: (el, e) => el.#on_WorldSettingsKidsKidEditElement_SavePlease(e),
                },
                {
                    type: 'WorldSettingsKidsKidEditElement:DeletePlease',
                    listener: (el, e) => el.#on_WorldSettingsKidsKidEditElement_DeletePlease(e),
                },
            ],
        }
    }; }
    ...
    async #on_WorldSettingsKidsKidEditElement_SavePlease(e) {
        ...
        const { url, method } = payload.id === undefined ?
            {
                url: base,
                method: 'POST',
            }
...
//# sourceMappingURL=elements-world-settings-kids-steamside.js.map