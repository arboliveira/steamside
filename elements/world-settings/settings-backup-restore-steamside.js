...
export class SettingsBackupRestoreElement extends CustomaryElement {
        ...
        hooks: {
            ...
            events: [
                ...
                },
                {
                    ...
                    listener: (el, e) => el.#on_AllDataRead_DONE(e),
                },
                {
                    type: AllDataWrite.eventTypeDone,
                    listener: (el, _e) => el.#on_AllDataWrite_DONE(),
                },
            ]
        }
    }; }
    async #onBackupClick(e) {
        Skyward.stage(e, this, { type: AllDataRead.eventTypePlease });
    }
    async #on_AllDataRead_DONE(event) {
    ...
    async #onRestoreClick() {
        const restoreFileInput = this.renderRoot.querySelector("#RestoreFileInput");
        restoreFileInput.click();
    }
    async #onRestoreFileInputClick(e) {
...
//# sourceMappingURL=settings-backup-restore-steamside.js.map